...
class _$NotificationStateImpl extends _NotificationState {
  ...
  @override
  String toString() {
    return 'NotificationState(isLoading: $isLoading, isLoadingMore: $isLoadingMore, isSuccess: $isSuccess, notifications: $notifications, total: $total, unreadCount: $unreadCount, hasReachedMax: $hasReachedMax, error: $error)';
  }
...
abstract class _NotificationState extends NotificationState {
  factory _NotificationState(
      ...
      final int unreadCount,
      final bool hasReachedMax,
      final AppError? error}) = _$NotificationStateImpl;
