...
class _$CalendarStateImpl implements _CalendarState {
  const _$CalendarStateImpl(
      ...
      final List<CourseData> courses = const [],
      this.errorMessage})
      : _courses = courses;
  ...
  @override
  String toString() {
    return 'CalendarState(isLoading: $isLoading, isSuccess: $isSuccess, courses: $courses, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isLoading, isSuccess,
      const DeepCollectionEquality().hash(_courses), errorMessage);
