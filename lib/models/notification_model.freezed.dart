...
class _$NotificationModelImpl implements _NotificationModel {
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, title: $title, message: $message, notificationType: $notificationType, isRead: $isRead, createdAt: $createdAt, sourceId: $sourceId, status: $status)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, message,
      notificationType, isRead, createdAt, sourceId, status);
